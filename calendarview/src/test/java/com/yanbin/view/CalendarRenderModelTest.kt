...
class CalendarRenderModelTest {
    ...
    fun `Scroll to right with more than half of width should snap to prev month`() {
        val calendarRenderModel = CalendarRenderModel()
        calendarRenderModel.setDate(Date(2020, 2, 12))
        calendarRenderModel.viewWidth = 1000f
    ...
    fun `not able to scroll if it is snapping`() {
        ...
        //act
        calendarRenderModel.scrollHorizontally(600f)
        calendarRenderModel.calculateSnapOffset()
        Assertions.assertThat(calendarRenderModel.xOffset).isEqualTo(600f)
        calendarRenderModel.scrollHorizontally(100f)
    ...
    private fun scrollAndSnap(calendarRenderModel: CalendarRenderModel, distance: Float) {
        calendarRenderModel.scrollHorizontally(distance)
        val snapOffset = calendarRenderModel.calculateSnapOffset()
        calendarRenderModel.xOffset = snapOffset
